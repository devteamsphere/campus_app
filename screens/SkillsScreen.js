...
export default function SkillsScreen({navigation}) {
    ...
    return (
        <View>
            ...
            <Text style={{fontSize:22,fontFamily:"NSExtraBold"}}>Enhance your skills</Text>
            <Text>If you want to add any skill to your</Text>
            <Text>resume, pass the quiz of</Text>
            <Text>that particular</Text>
            <Text> skill.</Text>
            <Text style={{backgroundColor:"#000000",color:"white",padding:5,borderRadius:20,width:120,textAlign:"center",marginTop:6,}}> Start Learning</Text>
                    ...
                    {dataset ? dataset.map((item, index) => {
                        return (
                            ...
                            <View style={styles.labelAdd}>
                                <Text style={{ fontSize: 15, padding: 5, fontFamily: 'NSLight', color: "#000000", textAlign: "center" }} onPress={()=>{
                                console.log('first');
